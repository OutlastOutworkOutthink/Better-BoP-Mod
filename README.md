# Better Battle of Polytopia Mod — Alpha 0.5.5
...
Alpha 0.5.5 targets both the visible legacy setup row and UI2's later layout
...
Download the Alpha 0.5.5 release ZIP, extract it, and place the
...
```text
Better BoP Alpha 0.5.5 loaded: Oblivion only.
```
